<?php
// analytics-agent-app/gitpull.php - Pulls latest changes from the Git repository

// You might want to secure this endpoint with some authentication in a real application.

// Set the path to your repository
// Assuming the script is in the root of the Git repository (analytics-agent-app/)
